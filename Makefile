...
## marker
	cat target/kubernetes/helloworlds.operator.workshop.com-v1.yml target/kubernetes/kubernetes.yml | operator-sdk generate bundle -q --overwrite --version 0.1.1 --default-channel=stable --channels=stable --package=workshop-operator-hello-world
